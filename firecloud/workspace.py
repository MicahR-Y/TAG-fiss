...
class Workspace(object):
    ...
    def bucket_use(self):
        """Get the bucket use for this workspace."""
        r = fapi.get_bucket_usage(self.namespace, self.name, self.api_url)
        fapi._check_response_code(r, 200)
        return r.json()

    def storage_cost(self):
        """Get the bucket use for this workspace."""
        r = fapi.get_storage_cost(self.namespace, self.name, self.api_url)
        fapi._check_response_code(r, 200)
        return r.json()
